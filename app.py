...
"""
def get_db_connection():
	_conn = mysql.connector.connect(user='root',password='',host='localhost',database='gym',port=3306)
	return _conn
...
def update_password(username):
	...
	if request.method == 'POST' and form.validate():
		...
		cur.close()
		"""
		cur.execute("UPDATE info SET password = %s WHERE username = %s", username)
		conn.commit()
		cur.close()
